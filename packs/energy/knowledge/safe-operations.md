...
(T/S/C/A are the four channel point types — telemetry, signal, control, adjustment; M denotes an instance measurement point — see [Aether Data Model](https://github.com/EvanL1/AetherEdge/blob/7c427f41dbe6a7780cb96a162f60fdc2a065cff5/docs/concepts/data-model.md).)
...
public surface is listed in [Aether MCP Tools Reference](https://github.com/EvanL1/AetherEdge/blob/7c427f41dbe6a7780cb96a162f60fdc2a065cff5/docs/reference/mcp-tools.md).
...
[Aether ADR-0008](https://github.com/EvanL1/AetherEdge/blob/7c427f41dbe6a7780cb96a162f60fdc2a065cff5/docs/adr/0008-application-control-boundary.md) for the trust boundary.

## Reading state correctly

Three properties of Aether's data model routinely mislead agents that assume a conventional "device object with a status field" design. Misreading any of them can turn a well-intentioned write into a harmful one. See [Aether Data Model](https://github.com/EvanL1/AetherEdge/blob/7c427f41dbe6a7780cb96a162f60fdc2a065cff5/docs/concepts/data-model.md) for the full picture.
...
- [Aether System Architecture](https://github.com/EvanL1/AetherEdge/blob/7c427f41dbe6a7780cb96a162f60fdc2a065cff5/docs/concepts/architecture.md) — the services these tools talk to
- [Aether Data Model](https://github.com/EvanL1/AetherEdge/blob/7c427f41dbe6a7780cb96a162f60fdc2a065cff5/docs/concepts/data-model.md) — instances, channels, points, and why they are orthogonal
- [Using Aether with AI Assistants](https://github.com/EvanL1/AetherEdge/blob/7c427f41dbe6a7780cb96a162f60fdc2a065cff5/docs/guides/ai-assistants.md) — setting up the MCP server
- [Aether CLI Reference](https://github.com/EvanL1/AetherEdge/blob/7c427f41dbe6a7780cb96a162f60fdc2a065cff5/docs/reference/cli.md) — the `aether` commands behind each tool
