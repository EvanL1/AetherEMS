...
- declarative Pack assets cannot bypass AetherIot application boundaries;
- AetherIot dependency identity and release provenance fail closed;
...
reported to the upstream AetherIot repository.
